                        ...
                        >
                            <SubMenu key="sub1" icon={<AppstoreOutlined />} title="ข้อมูลส่วนตัว">
                                ...
                                <Menu.Item style={{backgroundColor:'#D3D3D3'}}>
                                    <span onClick={() => router.push("/user/jobone")}> xxxx</span>
                                </Menu.Item>
                                <Menu.Item style={{backgroundColor:'#D3D3D3'}}>
                                    <span onClick={() => router.push("")}> xxxxx </span>
                                </Menu.Item>
                                <Menu.Item style={{backgroundColor:'#D3D3D3'}}>
                                    <span onClick={() => router.push("")}> xxxx </span>
                                </Menu.Item>
                                <Menu.Item style={{backgroundColor:'#D3D3D3'}}>
                                    <span onClick={() => router.push("")}>  ประวัติการทำงาน</span>
                                </Menu.Item>
